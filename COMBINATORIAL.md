...
- [OpenShell](https://github.com/NVIDIA/OpenShell) ⭐5,737 — OpenShell is the safe, private runtime for autonomous AI agents.
- [open-agents](https://github.com/vercel-labs/open-agents) ⭐5,311 — An open source template for building cloud agents.
- [byterover-cli](https://github.com/campfirein/byterover-cli) ⭐4,719 — ByteRover CLI (brv) - The portable memory layer for  autonomous coding agents (f
- [openui](https://github.com/thesysdev/openui) ⭐4,545 — The Open Standard for Generative UI
...
- [agent-browser](https://github.com/vercel-labs/agent-browser) ⭐32,576 — Browser automation CLI for AI agents
- [awesome-ai-agents](https://github.com/e2b-dev/awesome-ai-agents) ⭐27,752 — A list of AI autonomous agents
- [multica](https://github.com/multica-ai/multica) ⭐26,915 — The open-source managed agents platform. Turn coding agents into real teammates 
- [OpenViking](https://github.com/volcengine/OpenViking) ⭐23,741 — OpenViking is an open-source context database designed specifically for AI Agent
- [awesome-agent-skills](https://github.com/VoltAgent/awesome-agent-skills) ⭐21,134 — A curated collection of 1000+ agent skills from official dev teams and the commu
- [promptfoo](https://github.com/promptfoo/promptfoo) ⭐21,107 — Test your prompts, agents, and RAGs. Red teaming/pentesting/vulnerability scanni
- [adk-python](https://github.com/google/adk-python) ⭐19,561 — An open-source, code-first Python toolkit for building, evaluating, and deployin
...
- [sandcastle](https://github.com/mattpocock/sandcastle) ⭐4,049 — Orchestrate sandboxed coding agents in TypeScript with sandcastle.run()
- [openclaw-mission-control](https://github.com/abhi1693/openclaw-mission-control) ⭐3,946 — AI Agent Orchestration Dashboard - Manage AI agents, assign tasks, and coordinat
- [hermes-workspace](https://github.com/outsourc-e/hermes-workspace) ⭐3,847 — Native web workspace for Hermes Agent — chat, terminal, memory, skills, inspecto
- [docker-agent](https://github.com/docker/docker-agent) ⭐2,902 — AI Agent Builder and Runtime by Docker Engineering
- [ralph-orchestrator](https://github.com/mikeyobrien/ralph-orchestrator) ⭐2,850 — An improved implementation of the Ralph Wiggum technique for autonomous AI agent
- [awesome-hermes-agent](https://github.com/0xNyk/awesome-hermes-agent) ⭐2,799 — A curated list of awesome skills, tools, integrations, and resources for Hermes 
- [openpencil](https://github.com/ZSeven-W/openpencil) ⭐2,580 — The world's first open-source AI-native vector design tool and the first to feat
- [OpenGame](https://github.com/leigest519/OpenGame) ⭐2,095 — OpenGame: Open Agentic Coding for Games
- [memsearch](https://github.com/zilliztech/memsearch) ⭐1,644 — A persistent, unified memory layer for all your AI agents (e.g. Claude Code, Cod
- [overstory](https://github.com/jayminwest/overstory) ⭐1,287 — Multi-agent orchestration for AI coding agents — pluggable runtime adapters for 
...
- [OpenViking](https://github.com/volcengine/OpenViking) ⭐23,741 — OpenViking is an open-source context database designed specifically for AI Agent
- [promptfoo](https://github.com/promptfoo/promptfoo) ⭐21,107 — Test your prompts, agents, and RAGs. Red teaming/pentesting/vulnerability scanni
- [heretic](https://github.com/p-e-w/heretic) ⭐20,713 — Fully automatic censorship removal for language models
- [adk-python](https://github.com/google/adk-python) ⭐19,561 — An open-source, code-first Python toolkit for building, evaluating, and deployin
- [opik](https://github.com/comet-ml/opik) ⭐19,265 — Debug, evaluate, and monitor your LLM applications, RAG systems, and agentic wor
- [DeepResearch](https://github.com/Alibaba-NLP/DeepResearch) ⭐18,838 — Tongyi Deep Research, the Leading Open-source Deep Research Agent
- [web-llm](https://github.com/mlc-ai/web-llm) ⭐17,949 — High-performance In-browser LLM Inference Engine 
...
Starred:
- [openclaw](https://github.com/openclaw/openclaw) ⭐370,582 — Your own personal AI assistant. Any OS. Any Platform. The lobster way. 🦞 
- [claw-code](https://github.com/ultraworkers/claw-code) ⭐190,976 — The repo is finally unlocked. enjoy the party! The fastest repo in history to su
- [warp](https://github.com/warpdotdev/warp) ⭐57,323 — Warp is an agentic development environment, born out of the terminal.
- [RustTraining](https://github.com/microsoft/RustTraining) ⭐14,261 — Beginner, advanced, expert level Rust training material
- [lovcode](https://github.com/lovstudio/lovcode) ⭐329 — A desktop companion app for AI coding tools. Browse Claude Code chat history, ma
...
- [claude-context](https://github.com/zilliztech/claude-context) ⭐10,922
- [BrowserOS](https://github.com/browseros-ai/BrowserOS) ⭐10,859
- [ClawX](https://github.com/ValueCell-ai/ClawX) ⭐7,122
- [open-agents](https://github.com/vercel-labs/open-agents) ⭐5,311
- [byterover-cli](https://github.com/campfirein/byterover-cli) ⭐4,719
- [openui](https://github.com/thesysdev/openui) ⭐4,545
- [openpencil](https://github.com/ZSeven-W/openpencil) ⭐2,580
- [memsearch](https://github.com/zilliztech/memsearch) ⭐1,644

### `ui` (17 repos)

- [open-webui](https://github.com/open-webui/open-webui) ⭐136,503
- [netdata](https://github.com/netdata/netdata) ⭐78,764
- [Front-End-Checklist](https://github.com/thedaviddias/Front-End-Checklist) ⭐72,571
- [zustand](https://github.com/pmndrs/zustand) ⭐57,994
- [warp](https://github.com/warpdotdev/warp) ⭐57,323
- [oh-my-openagent](https://github.com/code-yeongyu/oh-my-openagent) ⭐57,025
...
- [openui](https://github.com/thesysdev/openui) ⭐4,545
- [hermes-workspace](https://github.com/outsourc-e/hermes-workspace) ⭐3,847
- [openpencil](https://github.com/ZSeven-W/openpencil) ⭐2,580
...
- [OpenHands](https://github.com/OpenHands/OpenHands) ⭐73,096
- [oh-my-openagent](https://github.com/code-yeongyu/oh-my-openagent) ⭐57,025
- [nanobot](https://github.com/HKUDS/nanobot) ⭐42,153
...
- [developer-roadmap](https://github.com/nilbuild/developer-roadmap) ⭐354,539
...
- [compound-engineering-plugin](https://github.com/EveryInc/compound-engineering-plugin) ⭐16,476
- [claude-context](https://github.com/zilliztech/claude-context) ⭐10,922
