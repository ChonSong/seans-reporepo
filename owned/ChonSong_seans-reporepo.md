...
> Personal code catalog for ideation and combinatorial app design

**URL:** [ChonSong/seans-reporepo](https://github.com/ChonSong/seans-reporepo)
...
- **License:** unknown
- **Tags:** agent, ai, aie, api, audio, automation, awesome-list, backup, bot, browser-automation, cli, code-packing, energy, gaming, go, harness, hermes-agent, ide, infrastructure, llm, mobile, python, transpilation, typescript, voice, web-app
...
| [casaos-webhook-emitter](owned/ChonSong_casaos-webhook-emitter.md) | Go | 21 KB | ...
