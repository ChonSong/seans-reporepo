...
> Complete mobile-optimized VS Code code-server setup with touch-friendly interface, responsive design, and autonomous development workflow

**URL:** [ChonSong/mobile-codeovertcp.com](https://github.com/ChonSong/mobile-codeovertcp.com)
...
- **License:** unknown
- **Tags:** ai, backup, ide, mobile, nginx, proxy, remote-dev
