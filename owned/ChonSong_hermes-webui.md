...
url: 'https://github.com/ChonSong/hermes-webui'
...
**URL:** [ChonSong/hermes-webui](https://github.com/ChonSong/hermes-webui)
...
- **License:** unknown
- **Tags:** agent, ai, bot, browser-automation, cli, framework, hermes-agent, ide, python, terminal, web-app
